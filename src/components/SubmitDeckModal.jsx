      ...
      <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto shadow-2xl">
        <div className="p-8">
          ...
          <div className="flex justify-between items-center mb-8">
            <h2 className="text-2xl font-light text-gray-900 tracking-wide">Upload Deck PDF</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              ...
              <input
                type="text"
                required
                className="w-full border border-gray-200 rounded-lg px-4 py-3 focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent font-light"
            ...
            {/* Category Selection */}
            <div>
              <h3 className="text-lg font-light text-gray-900 mb-6 tracking-wide">Choose Category</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {categories.map((category) => (
                  <button
                    key={category.id}
                    type="button"
                    className={`p-4 border rounded-lg text-sm font-light tracking-wide transition-all duration-200 ${
            ...
            {/* Funding Required */}
            <div>
              <h3 className="text-lg font-light text-gray-900 mb-6 tracking-wide">Funding Required</h3>
              <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
                {[
                  'Under $50K',
                  '$50K — $250K',
            ...
            {/* Expiry */}
            <div>
              <h3 className="text-lg font-light text-gray-900 mb-3 tracking-wide">Expiry</h3>
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <button
                    key={option.value}
                    type="button"
                    className={`px-6 py-3 border rounded-lg text-sm font-light tracking-wide transition-all duration-200 ${
            ...
            <div className="bg-gray-50 border border-gray-100 p-6 rounded-xl">
              <h3 className="text-lg font-light text-gray-900 mb-4 tracking-wide">What happens next?</h3>
              <ol className="text-sm text-gray-600 space-y-2 font-light">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end space-x-4">
                <Button 
                  ...
                  variant="outline" 
                  onClick={onClose}
                  className="px-6 py-2 rounded-lg font-light tracking-wide border-gray-200 hover:bg-gray-50"
                >
                  Cancel
                </Button>
                <Button 
                  type="submit" 
                  className="bg-black hover:bg-gray-900 text-white px-6 py-2 rounded-lg font-light tracking-wide transition-all duration-200 hover:shadow-lg"
                >
                  Upload
                </Button>
              </div>
